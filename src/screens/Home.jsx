        ...
        <main>
                  ...
                  <div className="lg:py-24">
                    ...
                    >
                      <span className="rounded-full bg-gradient-to-r from-teal-500 to-cyan-600 px-3 py-0.5 text-sm font-semibold leading-5 text-white">
                        We're working with multiple countries
                      </span>
          ...
          <div className="relative bg-gray-50 pt-16 sm:pt-24 lg:pt-32">
            <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
              <div>
                <h2 className="text-lg font-semibold text-cyan-600">Planless</h2>
                <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                  No plan? No problem.
                </p>
                <p className="mx-auto mt-5 max-w-prose text-xl text-gray-500">
                  We got the most interesting and heated plans that you can find, discover and choose with us.
          ...
          <div className="mx-auto max-w-md px-4 pt-12 sm:max-w-7xl sm:px-6 lg:px-8 lg:pt-16">
            <div className="xl:grid xl:grid-cols-3 xl:gap-8">
              <div className="space-y-8 xl:col-span-1">
                <img
                  className="h-10"
                  src="https://i.postimg.cc/HxhDGW88/site-logo2.png"
                  alt="AnasBooking"
                />
                <p className="text-base text-gray-500">
                  Making the world a better place through planing and organizing hotel reservation.
                </p>
            ...
            <div className="mt-12 border-t border-gray-200 py-8">
              <p className="text-base text-gray-400 xl:text-center">
                &copy; 2022 AnasBooking, Inc. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
